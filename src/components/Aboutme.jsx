  ...
  useEffect(() => {
    ...
    lenis.on('scroll', (e) => {
      ...
      if (scrollTextRef.current) {
        scrollTextRef.current.style.opacity = Math.max(1 - e.scroll / 200, 0);
      }
    ...
    <div className='aboutme_container'>
      ...
      <section className='aboutme_section aboutme_section_one'>
        <div className='aboutmesecone_wrp'>
          ...
          <h3>BUCHAREST</h3>
          <p ref={scrollTextRef}>Scroll down for more</p>
        </div>
      </section>
      ...
      <section className='aboutme_section aboutme_section_contact'>
        <div className='aboutme_row'>
          ...
          <div className='aboutme_social'>
            ...
            <a href='https://www.linkedin.com/in/stan-ionut-1193a0159/' target='_blank' rel="noreferrer">
